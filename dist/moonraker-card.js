class MoonrakerCard extends HTMLElement {
    ...
    renderCard() {
        ...
        // Updated CSS and HTML structure with relative image paths
    ...
    handleAction(action) {
      // Replace 'moonraker_control' with the actual service name for controlling Moonraker
      this._hass.callService('moonraker', action, {
        entity_id: this.config.entities.control
      });
    }
